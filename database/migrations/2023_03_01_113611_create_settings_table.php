...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('settings', function (Blueprint $table) {
            ...
            // PAYMENT
            $table->string('default_currency')->default('2')->nullable();
            $table->string('tax_rate')->nullable();
            $table->string('stripe_active')->default(0)->nullable();
            $table->string('stripe_key')->nullable();
            $table->string('stripe_secret')->nullable();
            $table->string('stripe_base_url')->default('https://api.stripe.com')->nullable();
        
            $table->string('bank_transfer_active')->default(0)->nullable();
            $table->string('bank_transfer_instructions')->nullable();
            $table->string('bank_transfer_informations')->nullable();
        
            // GLOBAL SETTINGS
            $table->string('site_name')->default('MagicAI')->nullable();
            $table->string('site_url')->default('https://liquid-themes.com')->nullable();
            $table->string('site_email')->nullable();
            $table->string('google_analytics_active')->default(0)->nullable();
            $table->text('google_analytics_code')->nullable();
            $table->string('logo')->default('magicAI-logo.svg')->nullable();
            $table->string('favicon')->nullable();
            $table->text('meta_title')->nullable();
            $table->text('meta_description')->nullable();
        
            // SOCIAL LOGIN
            $table->boolean('facebook_active')->default(0)->nullable();
            $table->text('facebook_api_key')->nullable();
            $table->text('facebook_api_secret')->nullable();
            $table->text('facebook_redirect_url')->nullable();
        
            $table->boolean('github_active')->default(0)->nullable();
            $table->text('github_api_key')->nullable();
            $table->text('github_api_secret')->nullable();
            $table->text('github_redirect_url')->nullable();
        
            $table->boolean('google_active')->default(0)->nullable();
            $table->text('google_api_key')->nullable();
            $table->text('google_api_secret')->nullable();
            $table->text('google_redirect_url')->nullable();
        
            $table->boolean('twitter_active')->default(0)->nullable();
            $table->text('twitter_api_key')->nullable();
            $table->text('twitter_api_secret')->nullable();
            $table->text('twitter_redirect_url')->nullable();
        
            // REGISTER
            $table->boolean('register_active')->default(1)->nullable();
            $table->string('default_country')->default('United States')->nullable();
